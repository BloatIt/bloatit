 ...
 * 
 * There are some common rules: <li>If a method return a simple object then the return
 * value can be null (If the object is not found.)</li> <li>If a method return a
 * collection then the collection is always != null (but can be empty)</li>
 */
