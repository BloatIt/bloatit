...
public class DemandSummaryComponent extends PageComponent {

    private final DemandPage demandPage;

    public DemandSummaryComponent(DemandPage demandPage) {
    ...
    protected HtmlComponent produce() {
        ...
        {
            abstractBlock.add(new DemandTimelineComponent(demandPage));
        }
