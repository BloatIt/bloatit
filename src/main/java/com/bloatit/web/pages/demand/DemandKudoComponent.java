...
public class DemandKudoComponent extends PageComponent {

    private final DemandPage demandPage;

    public DemandKudoComponent(DemandPage demandPage) {
    ...
    protected HtmlComponent produce() {
        ...
        {
            HtmlKudoBox kudoBox = new HtmlKudoBox(demandPage.getDemand(), session);
