...
public abstract class RestResource implements Linkable {
     ...
     * 
     * @param requestMethod
     *            the method used for access, must be either <code>GET</code>,
     ...
     * @see #doDelete()
     */
    public RestResource(String requestMethod) {
        super();
        try {
    ...
    public final void writeToHttp(final HttpResponse response) throws IOException {
        ...
        } catch (NotAvailableRestMethodException e) {
     ...
     * </p>
     * 
     * @throws NotAvailableRestMethodException
