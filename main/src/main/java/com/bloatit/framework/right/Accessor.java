 ...
 * feature.
 * 
 * It implements two methods : canAccess that return a boolean if you can access
 * the
 * feature and tryAccess that throw an {@link UnauthorizedOperationException} if
 * you
 * cannot.
 * 
 ...
 * 
 * You have to create an Accessor child class for each feature. For example you
 * could
 * have:
 * 
 * <pre>
