 ...
 * </p>
 * <p>
 * When constructing a MultipartMime from a byte array, parsing will occur and build a
 * tree containing each elements. Note: class can only handle single level right now, and
...
public class MultipartMime {
     ...
     * </p>
     * <p>
     * The <code>postBytes</code> will be parsed using the <code>boundary</code> contained
     * in <code>contentType</code>
     * </p>
     * <p>
     * Example contentType:
     *
     ...
     * <p>
     *
     * @param postBytes the bytes to parse
     * @param contentType The contentType of the mimeElement, including it's boundary
     * @throws NonOptionalParameterException if any parameter (<code>postBytes</code> or
     ...
     * @return the element with a matching name, or null if no element has such a name
     */
     ...
     * </p>
     *
     * @param headerBytes the bytes containing the header
    ...
    /**
     * Returns a string representation of the content type. This string is build to be
     * displayed in a console for debug and not to be used in any other situation. Perform
     * your own tree parsing if you need to display in any other fashion.
     */
    @Override
