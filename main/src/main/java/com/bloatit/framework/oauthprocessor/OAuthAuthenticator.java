...
public abstract class OAuthAuthenticator {
    ...
    protected abstract void addExternalService(String clientId, String login, String password, final String token, Set<String> scopes) throws ElementNotFoundException;
