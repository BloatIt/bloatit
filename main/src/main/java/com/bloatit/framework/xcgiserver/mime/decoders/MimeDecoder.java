...
/**
 * <p>
 * Common interface used to provide tools to encode and decode data based on various
 * encoding methods of the <a href="http://tools.ietf.org/html/rfc2045">RFC 2045</a>
 * </p>
 */
public interface MimeDecoder {
     ...
     * </p>
     * <p>
     * When using this method, one should try to provide at least {@link #decodeStep()}
     * bytes at once. If not possible, the decode method will be performed using dummy
     * data resulting in possibly erroneous output.
     * </p>
     * 
     ...
     * </p>
     * <p>
     * If there is no such thing as a minimal amount of bytes to perform decoding, returns
     * 0.
     * </p>
     * 
     * @return the amount of byte to turn in to perform decoding, or <code>0</code> if
     *         there is no minimum number of bytes to turn in
     */
