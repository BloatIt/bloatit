...
/**
 * XcgiParcer is an interface to encode and decode a duplex stream corresponding to a cgi protocol using a socket.
 *
...
public interface XcgiParser {
    ...
    /**
     * Generate a map corresponding to http params. In really CGI, there are set in environnement variables
