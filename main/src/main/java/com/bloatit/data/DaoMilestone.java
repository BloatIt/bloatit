...
@NamedQueries(value = { @NamedQuery(
                        ...
                        @NamedQuery(
                           name = "milestone.getBugs.getAll",
                           query = "FROM DaoBug WHERE milestone = :this"),
                        @NamedQuery(
                           name = "milestone.getBugs.getAll.size",
                           query = "SELECT count(*) FROM DaoBug WHERE milestone = :this"),
                        @NamedQuery(
