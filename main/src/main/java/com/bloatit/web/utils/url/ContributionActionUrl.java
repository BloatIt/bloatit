...
public class ContributionActionUrl extends Url {
    ...
    public ContributionActionUrl(final Parameters params, final Parameters session) {
        this();
        parseParameters(params, false);
        parseParameters(session, true);
    }

    public ContributionActionUrl(final com.bloatit.framework.Demand targetIdea) {
        this();
    ...
    private UrlParameter<java.lang.String> comment = new UrlParameter<java.lang.String>("comment", null, java.lang.String.class, Role.SESSION,
            Level.INFO, "Error: invalid value (%value) for parameter \"%param\"");
    private UrlParameter<java.math.BigDecimal> amount = new UrlParameter<java.math.BigDecimal>("contributionAmount", null,
            java.math.BigDecimal.class, Role.SESSION, Level.ERROR, "Error: invalid value (%value) for parameter \"%param\"");
    ...
    public void setComment(final java.lang.String arg) {
    ...
    public ContributionActionUrl clone() {
        final ContributionActionUrl other = new ContributionActionUrl();
