...
/**
 * <p> Class that encapsulates all translation tools </p> <p> Tools provided are : <li>All
 * static translation tools (for the UI) implemented with gettext</li> <li>All Dynamic
 * translation tools (for the content), mostly for dates and currencies TODO and time</li>
 * </p>
 */
public class Localizator {
	...
	public Localizator(Locale locale) {
		this.locale = locale;
	...
	/**
	 * <p> Translates a constant String </p> <p> Returns <code>toTranslate</code>
	 * translated into the currently selected language. Every user-visible string in the
	 * program must be wrapped into this function </p>
	...
	/**
	 * <p> Translates a parametered constant string </p> <p> In <b>MOST CASES</b> the
	 * plural handling version should be used : see
	 * {@link #trn(String, String, long, Object...)} </p> <p> Returns
	 * <code>toTranslate</code> and replaces the string with the parameters </p> <p> One
	 * example : <p> <code>i18n.tr("foo {0} bar", new Integer(1024)));<br> //Will print
	 * "foo 1024 bar"</code> </p> For more examples see : {@link http
	...
	/**
	 * 
	 * <p> Translates a parametered-constant string, and handles plural </p> <p> Uses
	 * {@link MessageFormatter#format(String, Object, Object)} to format </p> <p> Example
	 * <br> <code>System.out.println(i18n.trn("Night {0} of 1001",
	 * "More than 1001 nights! {0} already!", 1002, new Integer(1024)));<br> // Will print
	 * "More than 1001 nights! 1024 already!"</code> </p> <p> For more examples see :
	...
	/**
	 * <p>Finds all available languages for the system<p>
	 * <p>Returns a map with [<language english name>:[<language local name><language ISO code>]]
	 * Example : [French:[Français,fr]] or [English:[English,en]]</p>
