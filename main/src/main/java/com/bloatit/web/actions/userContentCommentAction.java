...
public final class userContentCommentAction extends LoggedAction {
    ...
    private final UserContent<?> targetContent;

    @RequestParam(name = COMMENT_CONTENT_CODE, role = Role.POST)
    private final String comment;

    private final UserContentCommentActionUrl url;

    public userContentCommentAction(final UserContentCommentActionUrl url) {
        super(url);
        this.url = url;
        this.targetContent = url.getTargetContent();
    ...
    public Url doProcessRestricted() throws RedirectException {
        ...
        try {
            targetContent.addComment(comment);
