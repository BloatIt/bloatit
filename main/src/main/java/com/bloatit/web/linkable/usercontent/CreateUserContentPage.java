...
public abstract class CreateUserContentPage extends LoggedPage {
    ...
    // */
    // protected AsTeamField addAsTeamField(final HtmlForm form, final Member
    // me, final UserTeamRight right, final String label, final String comment)
    // {
    // final AsTeamField teamField = new AsTeamField(targetUrl, me, right,
    // label, comment);
    // form.add(teamField);
    // return teamField;
    // }
    ...
    // */
    // protected void addLanguageField(final HtmlForm form, final String label,
    // final String comment) {
    // form.add(new LanguageField(targetUrl, label, comment));
    // }
    //
    // protected void addAddAttachmentField(final HtmlForm form, final String
    // size) {
    // addAddAttachmentField(form,size,true);
    // }
    //
    // protected void addAddAttachmentField(final HtmlForm form, final String
    // size, boolean jsShowDown) {
