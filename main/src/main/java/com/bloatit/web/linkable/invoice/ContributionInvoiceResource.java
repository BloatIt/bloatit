 ...
 * @author fred
 */
@ParamContainer("contribution_invoice")
public final class ContributionInvoiceResource extends Resource {
    ...
    private final ContributionInvoice invoice;

    private File file;
    private String invoiceNumber;

    public ContributionInvoiceResource(final ContributionInvoiceResourceUrl url) throws PageNotFoundException {
        super(url);
