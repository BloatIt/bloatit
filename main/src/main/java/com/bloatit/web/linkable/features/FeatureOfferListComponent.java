...
public class FeatureOfferListComponent extends HtmlDiv {
    protected FeatureOfferListComponent(final Feature feature, Member me) {
        super();
        ...
        switch (feature.getFeatureState()) {
            ...
            case PREPARING: {
                ...
                if (selectedOffer != null) {
                    ...
                    block.addInRightColumn(new OfferBlock(selectedOffer, true, me));
                }
                ...
                for (final Offer offer : offers) {
                    if (offer != selectedOffer) {
                        unselectedBlock.addInRightColumn(new OfferBlock(offer, false, me));
                    }
                }
                break;
            }
            case DEVELOPPING:
                ...
                generateOldOffersList(offers, nbUnselected, selectedOffer, offersBlock, me);
    ...
    private void
            generateOldOffersList(final PageIterable<Offer> offers, final int nbUnselected, final Offer selectedOffer, final HtmlDiv offersBlock, Member me) {
        // UnSelected
