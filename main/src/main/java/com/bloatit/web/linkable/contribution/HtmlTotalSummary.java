...
public class HtmlTotalSummary extends HtmlTable {
    ...
    public HtmlTotalSummary(final StandardQuotation quotation,
        ...
        super(new HtmlTotalSummaryModel(quotation, showFeesDetails, myUrl));
...
//    
    ...
    private static class HtmlTotalSummaryModel extends HtmlLineTableModel{
        ...
        public HtmlTotalSummaryModel(final StandardQuotation quotation, boolean showFeesDetails, QuotationPageUrl myUrl) {
            //Subtotal
        ...
        feesDetailLine.addCell(cellDetailsMoney);
          ...
          showHideFees.addListener(cellDetailsMoney);
          showHideFees.addListener(cellDetailsLabel);
          showHideFees.apply();
