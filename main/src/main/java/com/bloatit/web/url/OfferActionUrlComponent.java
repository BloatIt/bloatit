...
public final class OfferActionUrlComponent extends UrlComponent {
public OfferActionUrlComponent(Parameters params, SessionParameters session) {
    this();
    parseSessionParameters(session);
    parseParameters(params);
}
public OfferActionUrlComponent(com.bloatit.model.Demand targetIdea) {
    this();
        this.targetIdea.setValue(targetIdea);
}
private OfferActionUrlComponent(){
    super();
}
private UrlParameter<com.bloatit.model.Demand, com.bloatit.model.Demand> targetIdea =  new UrlParameter<com.bloatit.model.Demand, com.bloatit.model.Demand>(null, new UrlParameterDescription<com.bloatit.model.Demand>("targetIdea", com.bloatit.model.Demand.class, Role.GET, RequestParam.DEFAULT_DEFAULT_VALUE, "The target idea is mandatory to make an offer.", Level.ERROR), new UrlParameterConstraints<com.bloatit.model.Demand>());
private UrlParameter<java.math.BigDecimal, java.math.BigDecimal> price =  new UrlParameter<java.math.BigDecimal, java.math.BigDecimal>(null, new UrlParameterDescription<java.math.BigDecimal>("offer_price", java.math.BigDecimal.class, Role.POST, RequestParam.DEFAULT_DEFAULT_VALUE, "Invalid or missing value for price field.", Level.ERROR), new UrlParameterConstraints<java.math.BigDecimal>());
private UrlParameter<com.bloatit.framework.utils.i18n.DateLocale, com.bloatit.framework.utils.i18n.DateLocale> expiryDate =  new UrlParameter<com.bloatit.framework.utils.i18n.DateLocale, com.bloatit.framework.utils.i18n.DateLocale>(null, new UrlParameterDescription<com.bloatit.framework.utils.i18n.DateLocale>("offer_expiry", com.bloatit.framework.utils.i18n.DateLocale.class, Role.POST, RequestParam.DEFAULT_DEFAULT_VALUE, RequestParam.DEFAULT_ERROR_MSG, Level.ERROR), new UrlParameterConstraints<com.bloatit.framework.utils.i18n.DateLocale>());
private UrlParameter<java.lang.String, java.lang.String> title =  new UrlParameter<java.lang.String, java.lang.String>(null, new UrlParameterDescription<java.lang.String>("offer_title", java.lang.String.class, Role.POST, RequestParam.DEFAULT_DEFAULT_VALUE, RequestParam.DEFAULT_ERROR_MSG, Level.ERROR), new UrlParameterConstraints<java.lang.String>());
private UrlParameter<java.lang.String, java.lang.String> description =  new UrlParameter<java.lang.String, java.lang.String>(null, new UrlParameterDescription<java.lang.String>("offer_description", java.lang.String.class, Role.POST, RequestParam.DEFAULT_DEFAULT_VALUE, RequestParam.DEFAULT_ERROR_MSG, Level.ERROR), new UrlParameterConstraints<java.lang.String>());
...
@Override 
public OfferActionUrlComponent clone() { 
    OfferActionUrlComponent other = new OfferActionUrlComponent();
