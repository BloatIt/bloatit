...
public final class PaylineReturnActionUrlComponent extends UrlComponent {
public PaylineReturnActionUrlComponent(Parameters params, SessionParameters session) {
    this();
    parseSessionParameters(session);
    parseParameters(params);
}
public PaylineReturnActionUrlComponent(java.lang.String ack) {
    this();
        this.ack.setValue(ack);
}
private PaylineReturnActionUrlComponent(){
    super();
}
...
@Override 
public PaylineReturnActionUrlComponent clone() { 
    PaylineReturnActionUrlComponent other = new PaylineReturnActionUrlComponent();
