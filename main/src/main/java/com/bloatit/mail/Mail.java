...
public class Mail {
     ...
     * 
     * @param to
     *            the email addresse of the receiver of the mail
     * @param title
     *            the title of the email
     * @param content
     *            the text content of the email
     * @param mailSenderID
     *            a unique identifier to the mail (recommended : the permanent
     *            id of the sender)
     */
    public Mail(String to, String title, String content, String mailSenderID) {
        this.to = to;
