...
public class DescriptionTranslatableTest extends TestCase {
    ...
    public void testCreateDescritpion() {
        ...
        final DaoDescription description = DaoDescription.createAndPersist(yo, new Locale("fr"), "title", "description");
    ...
    public void testCreateDescritpionAndTranslation() {
        ...
        final DaoDescription description = DaoDescription.createAndPersist(yo, new Locale("en"), "title", "description");
