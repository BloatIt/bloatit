 ...
 * 
 */
public class TestMultipartMimeParser extends TestCase {
    // public static void main(String[] args) throws MimeTypeParseException,
    // IOException, InvalidMimeEncodingException, MalformedMimeException {
    // // String toParse =
    ...
    //
    // MultipartMimeParser mmp = new MultipartMimeParser(bais, contentType, new
    // UUIDFileNameGenerator(), UPLOAD_TEMP_DIRECTORY);
    // MimeElement me;
     ...
     * @param name
     */
    public TestMultipartMimeParser(String name) {
        super(name);
