...
MIN_CLASSPATH=$ROOT/target/classes:$MAVEN_REPO/postgresql/postgresql/8.4-702.jdbc4/postgresql-8.4-702.jdbc4.jar:$MAVEN_REPO/dom4j/dom4j/1.6.1/dom4j-1.6.1.jar:$MAVEN_REPO/org/slf4j/slf4j-api/1.6.1/slf4j-api-1.6.1.jar:$MAVEN_REPO/org/slf4j/slf4j-jdk14/1.6.1/slf4j-jdk14-1.6.1.jar
